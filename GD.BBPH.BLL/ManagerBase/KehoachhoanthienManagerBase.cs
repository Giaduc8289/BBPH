...
namespace GD.BBPH.BLL
{
	public class KehoachhoanthienManagerBase
	{
		...
		{			
			...
			try
			{
				r[Field_Sometdukien]=_KehoachhoanthienEntity.Sometdukien;
			}
			catch { }
			
			try
			{
				r[Field_Sokgdukien]=_KehoachhoanthienEntity.Sokgdukien;
			}
			catch { }
			
			try
			{
				r[Field_Sldukien]=_KehoachhoanthienEntity.Sldukien;
			}
			catch { }
			
			try
			{
				r[Field_Tgdukien]=_KehoachhoanthienEntity.Tgdukien;
			}
			catch { }
		...
		{	
			...
			try
			{
				_KehoachhoanthienEntity.Sometdukien= System.Decimal.Parse(r[Field_Sometdukien].ToString());						
			}
			catch { }
			
			try
			{
				_KehoachhoanthienEntity.Sokgdukien= System.Decimal.Parse(r[Field_Sokgdukien].ToString());						
			}
			catch { }
			
			try
			{
				_KehoachhoanthienEntity.Sldukien= System.Int32.Parse(r[Field_Sldukien].ToString());						
			}
			catch { }
			
			try
			{
				_KehoachhoanthienEntity.Tgdukien= System.Int32.Parse(r[Field_Tgdukien].ToString());						
			}
			catch { }
		...
		{	
			...
			_KehoachhoanthienEntity.Sometdukien= _KehoachhoanthienEntity_XML.Sometdukien;
			
			_KehoachhoanthienEntity.Sokgdukien= _KehoachhoanthienEntity_XML.Sokgdukien;
			
			_KehoachhoanthienEntity.Sldukien= _KehoachhoanthienEntity_XML.Sldukien;
			
			_KehoachhoanthienEntity.Tgdukien= _KehoachhoanthienEntity_XML.Tgdukien;
		...
		public String InsertV2(KehoachhoanthienEntity _KehoachhoanthienEntity,DataRow r,DataTable dt,BindingSource _BindingSource)
		{
			...
			try
			{
				r.SetField(Field_Sometdukien,_KehoachhoanthienEntity.Sometdukien);
			}
			catch { }
			
			try
			{
				r.SetField(Field_Sokgdukien,_KehoachhoanthienEntity.Sokgdukien);
			}
			catch { }
			
			try
			{
				r.SetField(Field_Sldukien,_KehoachhoanthienEntity.Sldukien);
			}
			catch { }
			
			try
			{
				r.SetField(Field_Tgdukien,_KehoachhoanthienEntity.Tgdukien);
			}
			catch { }
		...
		public KehoachhoanthienEntity Insert(System.Int64  Id, System.String  Solenhsx, System.DateTime  Ngaydat, System.DateTime  Ngaygiao, System.String  Masanpham, System.String  Mamay, System.DateTime  Ngaychay, System.Int32  Ca, System.Int32  Soluong, System.Decimal  Somet, System.Decimal  Sokg, System.DateTime  Ngaytao, System.String  Nguoitao, System.DateTime  Ngaysua, System.String  Nguoisua, System.Decimal  Sometdukien, System.Decimal  Sokgdukien, System.Int32  Sldukien, System.Int32  Tgdukien)
		{
			...
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
				...
				_KehoachhoanthienEntity.Sometdukien = Sometdukien;
				
				_KehoachhoanthienEntity.Sokgdukien = Sokgdukien;
				
				_KehoachhoanthienEntity.Sldukien = Sldukien;
				
				_KehoachhoanthienEntity.Tgdukien = Tgdukien;
		...
		public int DeleteBySometdukien(System.Decimal Sometdukien)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(KehoachhoanthienFields.Sometdukien == Sometdukien);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		public int DeleteBySokgdukien(System.Decimal Sokgdukien)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(KehoachhoanthienFields.Sokgdukien == Sokgdukien);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		public int DeleteBySldukien(System.Int32 Sldukien)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(KehoachhoanthienFields.Sldukien == Sldukien);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		public int DeleteByTgdukien(System.Int32 Tgdukien)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(KehoachhoanthienFields.Tgdukien == Tgdukien);
			filter.PredicateExpression.Add(_PredicateExpression);
