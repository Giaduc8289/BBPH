		...
		public static IEntityFields2 CreateEntityFieldsObject(GD.BBPH.DAL.EntityType relatedEntityType)
		{
			...
			switch(relatedEntityType)
			{
				...
				case GD.BBPH.DAL.EntityType.DinhmuckeoEntity:
					fieldsToReturn = fieldProvider.GetEntityFields(inheritanceProvider, "DinhmuckeoEntity");
					break;
				...
				case GD.BBPH.DAL.EntityType.LenhsanxuatEntity:
					fieldsToReturn = fieldProvider.GetEntityFields(inheritanceProvider, "LenhsanxuatEntity");
					break;
				...
				case GD.BBPH.DAL.EntityType.MangcuahangEntity:
					fieldsToReturn = fieldProvider.GetEntityFields(inheritanceProvider, "MangcuahangEntity");
					break;
				case GD.BBPH.DAL.EntityType.MangtheolenhEntity:
					fieldsToReturn = fieldProvider.GetEntityFields(inheritanceProvider, "MangtheolenhEntity");
					break;
