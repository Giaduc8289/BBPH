...
namespace GD.BBPH.DAL.FactoryClasses
{
	...
	public partial class KeocuahangEntityFactory : EntityFactoryBase2 {
		/// <summary>CTor</summary>
		public KeocuahangEntityFactory() : base("KeocuahangEntity", GD.BBPH.DAL.EntityType.KeocuahangEntity) { }

		/// <summary>Creates a new, empty KeocuahangEntity object.</summary>
		/// <returns>A new, empty KeocuahangEntity object.</returns>
		public override IEntity2 Create() {
			IEntity2 toReturn = new KeocuahangEntity();
		...
		/// <summary>Creates a new KeocuahangEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new KeocuahangEntity(fields);
		...
		public override IEntityCollection2 CreateEntityCollection()
		{
			return new EntityCollection<KeocuahangEntity>(this);
		}
	...
	/// <summary>Factory to create new, empty MangtheolenhEntity objects.</summary>
	[Serializable]
	public partial class MangtheolenhEntityFactory : EntityFactoryBase2 {
		/// <summary>CTor</summary>
		public MangtheolenhEntityFactory() : base("MangtheolenhEntity", GD.BBPH.DAL.EntityType.MangtheolenhEntity) { }

		/// <summary>Creates a new, empty MangtheolenhEntity object.</summary>
		/// <returns>A new, empty MangtheolenhEntity object.</returns>
		public override IEntity2 Create() {
			IEntity2 toReturn = new MangtheolenhEntity();
		...
		/// <summary>Creates a new MangtheolenhEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new MangtheolenhEntity(fields);
		...
		public override IEntityCollection2 CreateEntityCollection()
		{
			return new EntityCollection<MangtheolenhEntity>(this);
		}
		...
		public static IEntity2 Create(GD.BBPH.DAL.EntityType entityTypeToCreate)
		{
			...
			switch(entityTypeToCreate)
			{
				...
				case GD.BBPH.DAL.EntityType.MangcuahangEntity:
					...
					break;
				case GD.BBPH.DAL.EntityType.MangtheolenhEntity:
					factoryToUse = new MangtheolenhEntityFactory();
					break;
