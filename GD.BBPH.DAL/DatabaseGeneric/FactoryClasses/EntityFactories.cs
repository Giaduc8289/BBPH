...
namespace GD.BBPH.DAL.FactoryClasses
{
	...
	/// <summary>Factory to create new, empty CautruccuahangEntity objects.</summary>
	[Serializable]
	public partial class CautruccuahangEntityFactory : EntityFactoryBase2 {
		/// <summary>CTor</summary>
		public CautruccuahangEntityFactory() : base("CautruccuahangEntity", GD.BBPH.DAL.EntityType.CautruccuahangEntity) { }

		/// <summary>Creates a new, empty CautruccuahangEntity object.</summary>
		/// <returns>A new, empty CautruccuahangEntity object.</returns>
		public override IEntity2 Create() {
			IEntity2 toReturn = new CautruccuahangEntity();
			
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewCautruccuahang
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		
		/// <summary>Creates a new CautruccuahangEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new CautruccuahangEntity(fields);
			
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewCautruccuahangUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		...
		public override IEntityCollection2 CreateEntityCollection()
		{
			return new EntityCollection<CautruccuahangEntity>(this);
		}
		...
		public static IEntity2 Create(GD.BBPH.DAL.EntityType entityTypeToCreate)
		{
			...
			switch(entityTypeToCreate)
			{
				...
				case GD.BBPH.DAL.EntityType.CautruccuahangEntity:
					factoryToUse = new CautruccuahangEntityFactory();
					break;
