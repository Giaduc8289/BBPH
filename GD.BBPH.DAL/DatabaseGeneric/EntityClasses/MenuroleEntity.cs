...
namespace GD.BBPH.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(GD.BBPH.DAL.EntityType.MenuroleEntity);
		}
		...
		public static IPrefetchPathElement2 PrefetchPathMenu
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(MenuEntityFactory))),
					(IEntityRelation)GetRelationsForField("Menu")[0], (int)GD.BBPH.DAL.EntityType.MenuroleEntity, (int)GD.BBPH.DAL.EntityType.MenuEntity, 0, null, null, null, null, "Menu", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathRoles
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RolesEntityFactory))),
					(IEntityRelation)GetRelationsForField("Roles")[0], (int)GD.BBPH.DAL.EntityType.MenuroleEntity, (int)GD.BBPH.DAL.EntityType.RolesEntity, 0, null, null, null, null, "Roles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{ 
			get { return (int)GD.BBPH.DAL.EntityType.MenuroleEntity; }
		}
		#endregion
