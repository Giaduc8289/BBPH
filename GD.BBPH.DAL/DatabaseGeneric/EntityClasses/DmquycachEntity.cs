...
namespace GD.BBPH.DAL.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Dmquycach'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class DmquycachEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static DmquycachEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public DmquycachEntity():base("DmquycachEntity")
		{
		...
		public DmquycachEntity(IEntityFields2 fields):base("DmquycachEntity")
		{
		...
		public DmquycachEntity(IValidator validator):base("DmquycachEntity")
		{
		...
		protected DmquycachEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return DmquycachEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Dmcongdoan":
					toReturn.Add(DmquycachEntity.Relations.DmcongdoanEntityUsingMaqc);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(DmquycachFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(DmquycachFieldIndex fieldIndex)
		{
		...
		{
			return new DmquycachRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoDmcongdoan()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DmcongdoanFields.Macd, null, ComparisonOperator.Equal, this.Maqc));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(GD.BBPH.DAL.EntityType.DmquycachEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(DmquycachEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _dmcongdoan, new PropertyChangedEventHandler( OnDmcongdoanPropertyChanged ), "Dmcongdoan", DmquycachEntity.Relations.DmcongdoanEntityUsingMaqc, true, signalRelatedEntity, "Dmquycach", false, new int[] { (int)DmquycachFieldIndex.Maqc } );
			_dmcongdoan = null;
		}
		...
		private void SetupSyncDmcongdoan(IEntity2 relatedEntity)
		{
			if(_dmcongdoan!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _dmcongdoan, new PropertyChangedEventHandler( OnDmcongdoanPropertyChanged ), "Dmcongdoan", DmquycachEntity.Relations.DmcongdoanEntityUsingMaqc, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this DmquycachEntity</param>
		...
		public  static DmquycachRelations Relations
		{
			get	{ return new DmquycachRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDmcongdoan
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DmcongdoanEntityFactory))),
					(IEntityRelation)GetRelationsForField("Dmcongdoan")[0], (int)GD.BBPH.DAL.EntityType.DmquycachEntity, (int)GD.BBPH.DAL.EntityType.DmcongdoanEntity, 0, null, null, null, null, "Dmcongdoan", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return DmquycachEntity.CustomProperties;}
		}
		...
		{
			get { return (System.String)GetValue((int)DmquycachFieldIndex.Tenquycach, true); }
		...
		public virtual DmcongdoanEntity Dmcongdoan
		{
			...
			set
			{
				if(base.IsDeserializing)
				{
					...
					{
						value.SetRelatedEntity(this, "Dmquycach");
					}
				}
				else
				{
					...
					else
					{
						if(_dmcongdoan!=value)
						{
							...
							relatedEntity.SetRelatedEntity(this, "Dmquycach");
							SetupSyncDmcongdoan(relatedEntity);
						}
					}
				}
		...
		{ 
			get { return (int)GD.BBPH.DAL.EntityType.DmquycachEntity; }
		}
		#endregion
