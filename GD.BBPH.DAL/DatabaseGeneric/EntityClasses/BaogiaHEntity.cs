...
namespace GD.BBPH.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BaogiaHEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public BaogiaHEntity():base("BaogiaHEntity")
		{
		...
		public BaogiaHEntity(IEntityFields2 fields):base("BaogiaHEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BaogiaHEntity</param>
		public BaogiaHEntity(IValidator validator):base("BaogiaHEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="sobaogia">PK value for BaogiaH which data should be fetched into this BaogiaH object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BaogiaHEntity(System.String sobaogia):base("BaogiaHEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.Sobaogia = sobaogia;
		}
		...
		/// <param name="validator">The custom validator object for this BaogiaHEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BaogiaHEntity(System.String sobaogia, IValidator validator):base("BaogiaHEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.Sobaogia = sobaogia;
		}
		...
		protected BaogiaHEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((BaogiaHFieldIndex)fieldIndex)
			{
				case BaogiaHFieldIndex.Makhach:
		...
		{
			return BaogiaHEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Dmkhach":
					toReturn.Add(BaogiaHEntity.Relations.DmkhachEntityUsingMakhach);
					break;
				case "BaogiaD":
		...
		public bool TestOriginalFieldValueForNull(BaogiaHFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(BaogiaHFieldIndex fieldIndex)
		{
		...
		{
			return new BaogiaHRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoBaogiaD()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(BaogiaDFields.Sobaogia, null, ComparisonOperator.Equal, this.Sobaogia));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(GD.BBPH.DAL.EntityType.BaogiaHEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BaogiaHEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Ngayhieuluc", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			_fieldsCustomProperties.Add("Noidung", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _dmkhach, new PropertyChangedEventHandler( OnDmkhachPropertyChanged ), "Dmkhach", BaogiaHEntity.Relations.DmkhachEntityUsingMakhach, true, signalRelatedEntity, "BaogiaH", resetFKFields, new int[] { (int)BaogiaHFieldIndex.Makhach } );		
			_dmkhach = null;
		}
		...
		private void SetupSyncDmkhach(IEntity2 relatedEntity)
		{
			if(_dmkhach!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _dmkhach, new PropertyChangedEventHandler( OnDmkhachPropertyChanged ), "Dmkhach", BaogiaHEntity.Relations.DmkhachEntityUsingMakhach, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this BaogiaHEntity</param>
		...
		public  static BaogiaHRelations Relations
		{
			get	{ return new BaogiaHRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathBaogiaD
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<BaogiaDEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BaogiaDEntityFactory))),
					(IEntityRelation)GetRelationsForField("BaogiaD")[0], (int)GD.BBPH.DAL.EntityType.BaogiaHEntity, (int)GD.BBPH.DAL.EntityType.BaogiaDEntity, 0, null, null, null, null, "BaogiaD", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDmkhach
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DmkhachEntityFactory))),
					(IEntityRelation)GetRelationsForField("Dmkhach")[0], (int)GD.BBPH.DAL.EntityType.BaogiaHEntity, (int)GD.BBPH.DAL.EntityType.DmkhachEntity, 0, null, null, null, null, "Dmkhach", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return BaogiaHEntity.CustomProperties;}
		}
		...
		{
			get { return BaogiaHEntity.FieldsCustomProperties;}
		}

		/// <summary> The Sobaogia property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Sobaogia"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.String Sobaogia
		{
			get { return (System.String)GetValue((int)BaogiaHFieldIndex.Sobaogia, true); }
			set	{ SetValue((int)BaogiaHFieldIndex.Sobaogia, value); }
		}

		/// <summary> The Ngaybaogia property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Ngaybaogia"<br/>
		/// Table field type characteristics (type, precision, scale, length): Date, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Ngaybaogia
		{
			get { return (Nullable<System.DateTime>)GetValue((int)BaogiaHFieldIndex.Ngaybaogia, false); }
			set	{ SetValue((int)BaogiaHFieldIndex.Ngaybaogia, value); }
		}

		/// <summary> The Ngayhieuluc property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Ngayhieuluc"<br/>
		/// Table field type characteristics (type, precision, scale, length): Date, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Ngayhieuluc
		{
			get { return (Nullable<System.DateTime>)GetValue((int)BaogiaHFieldIndex.Ngayhieuluc, false); }
			set	{ SetValue((int)BaogiaHFieldIndex.Ngayhieuluc, value); }
		}

		/// <summary> The Makhach property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Makhach"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Makhach
		{
			get { return (System.String)GetValue((int)BaogiaHFieldIndex.Makhach, true); }
			set	{ SetValue((int)BaogiaHFieldIndex.Makhach, value); }
		}
		...
		public virtual System.String Tenkhach
		{
			...
			set	{ SetValue((int)BaogiaHFieldIndex.Tenkhach, value); }
		}
		...
		{
			get { return (System.String)GetValue((int)BaogiaHFieldIndex.Noidung, true); }
			set	{ SetValue((int)BaogiaHFieldIndex.Noidung, value); }
		}
		...
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Ngaytao"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Ngaytao
		{
			get { return (Nullable<System.DateTime>)GetValue((int)BaogiaHFieldIndex.Ngaytao, false); }
			set	{ SetValue((int)BaogiaHFieldIndex.Ngaytao, value); }
		}

		/// <summary> The Nguoitao property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Nguoitao"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Nguoitao
		{
			get { return (System.String)GetValue((int)BaogiaHFieldIndex.Nguoitao, true); }
			set	{ SetValue((int)BaogiaHFieldIndex.Nguoitao, value); }
		}

		/// <summary> The Ngaysua property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Ngaysua"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> Ngaysua
		{
			get { return (Nullable<System.DateTime>)GetValue((int)BaogiaHFieldIndex.Ngaysua, false); }
			set	{ SetValue((int)BaogiaHFieldIndex.Ngaysua, value); }
		}

		/// <summary> The Nguoisua property of the Entity BaogiaH<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "baogia_h"."Nguoisua"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		...
		public virtual EntityCollection<BaogiaDEntity> BaogiaD
		{
			get
			{
				if(_baogiaD==null)
				{
					...
					_baogiaD.SetContainingEntityInfo(this, "BaogiaH");
				}
				return _baogiaD;
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_dmkhach != null)
						{
							_dmkhach.UnsetRelatedEntity(this, "BaogiaH");
						}
					}
					else
					{
						if(_dmkhach!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "BaogiaH");
						}
					}
				}
			}
		...
		{ 
			get { return (int)GD.BBPH.DAL.EntityType.BaogiaHEntity; }
		}
		#endregion
