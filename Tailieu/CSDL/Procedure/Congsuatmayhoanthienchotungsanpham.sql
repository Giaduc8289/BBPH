------------------------Công suất máy hoàn thiện cho từng sản phẩm------------
If Object_ID('dbo.Congsuatmayhoanthienchotungsanpham','P') is not null
	Drop Procedure dbo.Congsuatmayhoanthienchotungsanpham;
Go
Create Procedure dbo.Congsuatmayhoanthienchotungsanpham
	@Tungay		DATETIME,
	@Denngay	DATETIME
With Encryption As
	SET NOCOUNT ON;
	...
	-----Lệnh sản xuất với Ngày đặt <= Ngày cuối tháng, và kết quả hoàn thiện theo Lệnh		
	...
	-----Lấy số lượng trong đơn trừ đi kết quả đã hoàn thiện
	Select Solenhsx, Ngayphatlenh, Ngaybatdausx, Ngayhoanthanhsx
...
Exec Congsuatmayhoanthienchotungsanpham '12/03/2022', '12/31/2022'
