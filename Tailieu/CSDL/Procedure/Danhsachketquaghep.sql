...
Create Procedure dbo.Danhsachketquaghep
  ...
  As
	...
	From dbo.Ketquaghep kq left join dbo.dmmay dm on kq.Mamay = dm.Mamay left join dbo.dmhang hang on kq.Masanpham = hang.Masp left join dbo.dmcongnhan cn on kq.Macongnhan = cn.Macn
