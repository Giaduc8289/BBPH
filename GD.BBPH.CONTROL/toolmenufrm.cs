...
namespace GD.BBPH.CONTROL
{
    public partial class toolmenufrm : UserControl
    {
        ...
        private GD.BBPH.CONTROL.FORM _frmconfig;
        ...
        public GD.BBPH.CONTROL.FORM FRM_CONFIG 
        {
            get { return _frmconfig; }
            set { _frmconfig = value; }
        }
        public toolmenufrm(string xmlfile, DataTable dtconfig, GridEX _DataGridView,GD.BBPH.CONTROL.FORM _Form)
        {
            InitializeComponent();

            GD.BBPH.CONTROL.BUTTON.Loadimage(btnTimKiem, btnTimKiem.Name + ".xml");
            GD.BBPH.CONTROL.BUTTON.Loadimage(btnIn, btnIn.Name + ".xml");
            GD.BBPH.CONTROL.BUTTON.Loadimage(btnThoat, btnThoat.Name + ".xml");
        ...
        public toolmenufrm(string xmlfile, DataTable dtconfig, DataGridView _DataGridView, GD.BBPH.CONTROL.FORM _Form)
        {
            InitializeComponent();
        ...
        {
            GD.BBPH.CONTROL.setup setupview = new GD.BBPH.CONTROL.setup(XMLFILE);
