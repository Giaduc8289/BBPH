...
namespace GD.BBPH.CONTROL
{
    ...
    public class BTN_HIENTHI : Button
    {
        ...
        public static void Loadimage(GD.BBPH.CONTROL.BUTTON _BUTTON, string imagename)
        {
            try
            {
                //_BUTTON.Image = Image.FromFile(GD.BBPH.LIB.PATH.ERP_PATH + @"\IMG\Icon\" + imagename);
        ...
        private GD.BBPH.CONTROL.toolmenufrm _toolmenufrm;
