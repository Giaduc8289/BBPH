...
namespace GD.BBPH.LIB
{
     ...
     * doan nay` cho vao` method khi chay form.      
        ...
        GD.BBPH.LIB.GRID_USERCONTROL.Main_COMBO(dt, "Mabo", gridEX1, combo1, DmbohangFields.Tenbo.Name, DmbohangFields.Mabo.Name,true);
        GD.BBPH.LIB.GRID_USERCONTROL.Main_txtDATETIME("Ngaytao", txt_DATETIME, gridEX1,false);
     * 
    ...
    public class GRID_USERCONTROL
    {
        ...
        private static GD.BBPH.CONTROL.TEXTBOXDATE Control_txt_DATETIME = new GD.BBPH.CONTROL.TEXTBOXDATE();
        private static GD.BBPH.CONTROL.COMBO Control_combo1 = new GD.BBPH.CONTROL.COMBO();
        ...
        public static void addComboBox(DataTable dt_cobo, string colName_Cobo, GridEX gridEX1, COMBO combo1, string value_combo, string key_combo)
        {
            ...
            if (Control_Grid.CurrentColumn == Control_Grid.RootTable.Columns[colName_Cobo])
            {
                ...
                {                    
                    ...
                    GD.BBPH.LIB.COMBO_COMM.SOURCE(Control_combo1, txt_cobo, dt_cobo, value_combo, key_combo);
