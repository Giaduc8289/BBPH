...
namespace GD.BBPH.LIB
{
    public class STATIC_PARAM
    {
        ...
        public static string FormatNumber_Grid //= "#,##0.00";
        {
            ...
            {
                string value = "";
                if (GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE.Equals(".")) { value = "#,###,###,###"; }
                else
                {
                    value = "#" + GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE + "###" + GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE;
                    value = value + "###" + GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE + "###";// +GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE;
                    //value = value + "###" + GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_PHANCACH_VALUE + "###";
                }
                string str_THAP_PHAN_VALUE = "";
                for (int i = 0; i < GD.BBPH.LIB.STATIC_PARAM.THAMSO_GIA_TRI_THAP_PHAN_VALUE; i++)
                {
                    str_THAP_PHAN_VALUE = str_THAP_PHAN_VALUE + "0";
                }
                value = value + "." + str_THAP_PHAN_VALUE; //GD.BBPH.LIB.STATIC_PARAM.THAMSO_KY_TU_THAPPHAN_VALUE
                return value;
            }
            set
            {
