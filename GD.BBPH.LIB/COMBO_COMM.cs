...
namespace GD.BBPH.LIB
{
    ...
    {
        public static void SOURCE(GD.BBPH.CONTROL.COMBO combo, GD.BBPH.CONTROL.TEXTBOX linktextbox, DataTable dt, string Columvalue, string Columkey)
        {
            if (dt != null)
            {
                ...
                dtempcate.Rows.Add(new String[] { ""/*GD.BBPH.DATA.DMDONVI.MADONVI_TH*/, "Lựa chọn" });
        ...
        public static void SOURCE(bool sudungRow0, GD.BBPH.CONTROL.COMBO combo, GD.BBPH.CONTROL.TEXTBOX linktextbox, DataTable dt, string Columvalue, string Columkey)
        {
        ...
        public static void SOURCE(bool sudungRow0, bool Row0_isEmpty, GD.BBPH.CONTROL.COMBO combo, GD.BBPH.CONTROL.TEXTBOX linktextbox, DataTable dt, string Columvalue, string Columkey)
        {
            SOURCE(combo, linktextbox, dt, Columvalue, Columkey);
            if (sudungRow0)
            {
