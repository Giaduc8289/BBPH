...
namespace GD.BBPH.APP
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                string path = LIB.PATH.BBPH_PATH;
                SetPermissions(path);
                ...
                GD.BBPH.APP.HETHONG.FRM_LOGIN _FRM_LOGIN = new GD.BBPH.APP.HETHONG.FRM_LOGIN();
                _FRM_LOGIN.ShowDialog();
                if (_FRM_LOGIN.islogin == true) Application.Run(new GD.BBPH.APP.HETHONG.FRM_MAIN());
            }
            else
            {
                System.Threading.Thread.CurrentThread.CurrentCulture = new System.Globalization.CultureInfo("vi-VN");
