...
namespace GD.BBPH.APP.HETHONG
{
    public partial class FRM_USERS : FRM_DMPARENT
    {
        ...
        private GD.BBPH.CONTROL.JGridEX GRID_USERS = new GD.BBPH.CONTROL.JGridEX();
        ...
        public FRM_USERS()
        {
            ...
            //GD.BBPH.LIB.GRID_COMM.Create_GRID_CONIG(dt111, LIB.PATH.BBPH_PATH + @"\XMLCONFIG\FRM_USERS.xml");
            ...
            GD.BBPH.LIB.GRID_COMM.LOAD_GRID_UIPanel(LIB.PATH.BBPH_PATH + @"\XMLCONFIG\FRM_USERS.xml", GRID_USERS, uiPanel0Container);
            FORM_PROCESS();
        ...
        private void Text_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                // error1.SetError(_TextBox, GD.BBPH.DANHMUC.Properties.Resources.TexBox_EMTY);
                _TextBox.Focus();
            }
        }
        ...
        private void btn_LUULAI_Click(object sender, EventArgs e)
        {
           ...
           // if (GD.BBPH.BLL.MenuroleManager.Validating_TextBox(txt_MAQUOCGIA, txt_TENQUOCGIA, txt_TRANGTHAI) == false) return;
           // error1.Clear();
            GD.BBPH.LIB.FORM_PROCESS_UTIL.enableControls(false, uiPanel1Container, null);
           ...
           _UsersEntity = _UsersManager.SelectOne(USERID_PK);
                   ...
                   System.Windows.Forms.DialogResult.Yes)
            {
              ...
              //  GD.BBPH.LIB.TrayPopup.PoupStringMessage(GD.BBPH.APP.Properties.Resources.MessageTitle, GD.BBPH.APP.Properties.Resources.MessageContent_T);
                GD.BBPH.BLL.MenuroleManager.set_Enable_controls(_UsersManager.Convert(_UsersEntity), GD.BBPH.LIB.BUTTONACTION.BUTTONACTION_DELETE, _MenuroleEntity, ref btn_THEMMOI, ref btn_SUA, ref btn_LUULAI, ref btn_XOA, ref btn_KHOIPHUC);
            }
            GRID_USERS.Enabled = true;
        }
