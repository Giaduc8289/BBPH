        ...
        private void Menu_Click(object sender, System.EventArgs e)
        {
            ...
            switch (menu_tag)
            {
                ...
                case "FRM_BCKQINCHITIET":
                    ...
                    break;
                case "FRM_BCKQINTONGHOP":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCKQINTONGHOP") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCKQINTONGHOP()), mmru.Text);
                    break;

                case "FRM_BCKQTUACHITIET":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCKQTUACHITIET") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCKQTUACHITIET()), mmru.Text);
                    break;

                case "FRM_BCKQGHEPCHITIET":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCKQGHEPCHITIET") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCKQGHEPCHITIET()), mmru.Text);
                    break;
                case "FRM_BCKQCHIACHITIET":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCKQCHIACHITIET") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCKQCHIACHITIET()), mmru.Text);
                    break;
                case "FRM_BCKQHOANTHIENCHITIET":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCKQHOANTHIENCHITIET") { frm.Activate(); return; }
                    }
                ...
                case "FRM_BAOCAONHAPXUATTONKHONGUYENLIEU":
                    ...
                    break;
                case "FRM_BAOCAONHAPXUATTONKHOMANG":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BAOCAONHAPXUATTONKHOMANG") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BAOCAONHAPXUATTONKHOMANG()), mmru.Text);
                    break;
                ...
                case "FRM_BCLUONGTOTHOI":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCLUONGTOTHOI") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCLUONGTOTHOI()), mmru.Text);
                    break;
                case "FRM_BCLUONGTOGHEP":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                ...
                case "FRM_BCLUONGTOCHIA":
                    ...
                    break;
                case "FRM_BCLUONGTOHOANTHIEN":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCLUONGTOHOANTHIEN") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCLUONGTOHOANTHIEN()), mmru.Text);
                    break;
                case "FRM_BCTONGHOPLUONGTOCHIA":
                    ...
                    break;
                case "FRM_BCTONGHOPLUONGTOHOANTHIEN":
                    foreach (GD.BBPH.CONTROL.FORM frm in this.MdiChildren)
                    {
                        if (frm.Name == "FRM_BCTONGHOPLUONGTOHOANTHIEN") { frm.Activate(); return; }
                    }
                    ShowAsMDIChild((new GD.BBPH.APP.BAOCAO.FRM_BCTONGHOPLUONGTOHOANTHIEN()), mmru.Text);
                    break;
                #endregion
