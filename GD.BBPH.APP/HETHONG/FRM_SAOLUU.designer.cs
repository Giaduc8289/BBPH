namespace GD.BBPH.APP.HETHONG
{
    partial class FRM_SAOLUU
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnChapnhan = new GD.BBPH.CONTROL.BUTTON();
            this.btnThoat = new GD.BBPH.CONTROL.BUTTON();
            this.btnChonduongdan = new GD.BBPH.CONTROL.BUTTON();
            this.txt_THUMUC = new GD.BBPH.CONTROL.TEXTBOX();
            this.SuspendLayout();
            // 
            // label2
            // 
            ...
            this.btnChapnhan.BtnShape = GD.BBPH.CONTROL.emunType.BtnShape.Rectangle;
            this.btnChapnhan.BtnStyle = GD.BBPH.CONTROL.emunType.XPStyle.Default;
            ...
            this.btnThoat.BtnShape = GD.BBPH.CONTROL.emunType.BtnShape.Rectangle;
            this.btnThoat.BtnStyle = GD.BBPH.CONTROL.emunType.XPStyle.Default;
            ...
            this.btnChonduongdan.BtnShape = GD.BBPH.CONTROL.emunType.BtnShape.Rectangle;
            this.btnChonduongdan.BtnStyle = GD.BBPH.CONTROL.emunType.XPStyle.Default;
        ...
        private GD.BBPH.CONTROL.BUTTON btnChapnhan;
        private GD.BBPH.CONTROL.BUTTON btnThoat;
        private GD.BBPH.CONTROL.BUTTON btnChonduongdan;
        private GD.BBPH.CONTROL.TEXTBOX txt_THUMUC;
    }
}