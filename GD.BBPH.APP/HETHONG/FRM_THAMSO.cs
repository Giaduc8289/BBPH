...
{
    public partial class FRM_THAMSO : GD.BBPH.APP.DANHMUC.FRM_DMPARENT
    {
        public FRM_THAMSO()
        {
            InitializeComponent();
        ...
        private void CreateTab(ref DataTable dtView, ref TabPage m_tab, DataTable dt, int _index)
        {
            ...
            //GD.BBPH.CONTROL.JGridEX GRID_THAMSO = new GD.BBPH.CONTROL.JGridEX();
            //GD.BBPH.LIB.GRID_COMM.LOAD_GRID_SYS_TabPage(LIB.PATH.KTXPT_PATH + @"\XMLCONFIG\FRM_THAMSO.xml", GRID_THAMSO, m_tab, true);
        ...
        void m_tab_Paint(object sender, PaintEventArgs e)
        {
            ...
            //GD.BBPH.CONTROL.JGridEX GRID_THAMSO = (GD.BBPH.CONTROL.JGridEX)((TabPage)sender).Controls[0];
