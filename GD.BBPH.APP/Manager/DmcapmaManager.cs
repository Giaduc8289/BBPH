...
namespace GD.BBPH.BLL
{
	public class DmcapmaManager : DmcapmaManagerBase
	{
        ...
        public static string GET_MA_INT(string LOAI_MA, bool IsOk)
        {
            ...
            string day = GD.BBPH.DATA.DATE.NGAYHACHTOAN.Day.ToString();
            string month = GD.BBPH.DATA.DATE.NGAYHACHTOAN.Month.ToString();
            string year = GD.BBPH.DATA.DATE.NGAYHACHTOAN.Year.ToString().Substring(2, 2);
