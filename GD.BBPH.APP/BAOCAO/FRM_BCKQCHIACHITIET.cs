...
{
    public partial class FRM_BCKQCHIACHITIET : FRM_DMPARENT
    {
        ...
        private void btn_IN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _DataAccessAdapter.CallRetrievalStoredProcedure("Baocaoketquachiachitiet", parameters, dsKetqua, 0);
                ...
                #region Hien bao cao
                new FRM_REPORTVIEWER(dsKetqua, LIB.PATH.BBPH_PATH + @"\RDLC\KQCHIACHITIET.rdlc", "Ketqua", this.Text, true).Show();
                #endregion
            }
            catch (Exception ex)
            {
