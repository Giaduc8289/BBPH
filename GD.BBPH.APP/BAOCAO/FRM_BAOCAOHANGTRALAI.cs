...
{
    public partial class FRM_BAOCAOHANGTRALAI : FRM_DMPARENT
    {
        private DataTable DT_DMKHACH = new DataTable(), DT_DMHANG = new DataTable();
        private DataRow _RowViewSelect = null;
        private MenuroleEntity _MenuroleEntity = new MenuroleEntity();
        private string FUNCTION = "LOAD";
        public FRM_BAOCAOHANGTRALAI()
        {
            InitializeComponent();
        ...
        private void btn_IN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                parameters[2] = new SqlParameter("@Makhach", _Makhach);
                parameters[3] = new SqlParameter("@Masanpham", _Masanpham);
                _DataAccessAdapter.CallRetrievalStoredProcedure("Baocaohangtralai", parameters, dsKetqua, 0);
                ...
                #region Hien bao cao
                new FRM_REPORTVIEWER(dsKetqua, LIB.PATH.BBPH_PATH + @"\RDLC\BAOCAOHANGTRALAI.rdlc", "Ketqua", this.Text, true).Show();
                #endregion
            }
            catch (Exception ex)
            {
        ...
        private void txt_MAKHACH_Validating(object sender, CancelEventArgs e)
        {
            ...
            _RowViewSelect = checkmaMay(_str_MACANTIM, DT_DMKHACH);
        ...
        private void FRM_BAOCAOHANGTRALAI_Load(object sender, EventArgs e)
        {
