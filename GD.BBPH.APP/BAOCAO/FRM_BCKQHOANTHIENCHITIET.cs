...
{
    public partial class FRM_BCKQHOANTHIENCHITIET : FRM_DMPARENT
    {
        ...
        public FRM_BCKQHOANTHIENCHITIET()
        {
            InitializeComponent();
        ...
        private void btn_IN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _DataAccessAdapter.CallRetrievalStoredProcedure("Baocaoketquahoanthienchitiet", parameters, dsKetqua, 0);
                ...
                #region Hien bao cao
                new FRM_REPORTVIEWER(dsKetqua, LIB.PATH.BBPH_PATH + @"\RDLC\KQHOANTHIENCHITIET.rdlc", "Ketqua", this.Text, true).Show();
                #endregion
            }
            catch (Exception ex)
            {
