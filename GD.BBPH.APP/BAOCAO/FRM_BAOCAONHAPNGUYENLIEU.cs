...
{
    public partial class FRM_BAOCAONHAPNGUYENLIEU : FRM_DMPARENT
    {
        ...
        public FRM_BAOCAONHAPNGUYENLIEU()
        {
            InitializeComponent();
        ...
        private void btn_IN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _DataAccessAdapter.CallRetrievalStoredProcedure("Baocaonhapnguyenlieu", parameters, dsKetqua, 0);
                ...
                #region Hien bao cao
                new FRM_REPORTVIEWER(dsKetqua, LIB.PATH.BBPH_PATH + @"\RDLC\BAOCAONHAPNGUYENLIEU.rdlc", "Ketqua", this.Text, true).Show();
                #endregion
            }
            catch (Exception ex)
            {
