  ...
  public  class Procedures
    {
        ...
        public static DataTable Kehoachgheptheocamay(DateTime Ngay, int Ca, string May)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Kehoachgheptheocamay", "Kehoachgheptheocamay", myArr).Tables[0];
        }
        ...
        public static void Xoakehoachchia(string Solenhsx, DateTime Tungay, DateTime Denngay)
        {
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            _SimpleStoredProcedure.ExecuteSPReader(timeout, "Xoakehoachchia", "Xoakehoachchia", myArr);
        }
        ...
        public static void Xoakehoachhoanthien(string Solenhsx, DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Solenhsx", SqlDbType.NVarChar, 0), Solenhsx);
        ...
        public static DataTable Kehoachthoidalap(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Kehoachthoidalap", "Kehoachthoidalap", myArr).Tables[0];
        }
        public static DataTable Kehoachghepdalap(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Kehoachghepdalap", "Kehoachghepdalap", myArr).Tables[0];
        }
        public static DataTable Kehoachtuadalap(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Kehoachtuadalap", "Kehoachtuadalap", myArr).Tables[0];
        }
        public static DataTable Kehoachhoanthiendalap(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Kehoachchiadalap(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Kehoachchiadalap", "Kehoacchiadalap", myArr).Tables[0];
        }
        public static DataTable Congsuatmayinchotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Thoigianchuanbimaytuachotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Thoigianchuanbimaytuachotungsanpham", "Thoigianchuanbimaytuachotungsanpham", myArr).Tables[0];
        }
        public static DataTable Thoigianchuanbimaychiachotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Thoigianchuanbimaychiachotungsanpham", "Thoigianchuanbimaychiachotungsanpham", myArr).Tables[0];
        }
        public static DataTable Thoigianchuanbimayhoanthienchotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Thoigianchuanbimayhoanthienchotungsanpham", "Thoigianchuanbimayhoanthienchotungsanpham", myArr).Tables[0];
        }
        public static DataTable Congsuatmayghepchotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Congsuatmayghepchotungsanpham", "Congsuatmayghepchotungsanpham", myArr).Tables[0];
        }
        public static DataTable Congsuatmaytuachotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Congsuatmaytuachotungsanpham", "Congsuatmaytuachotungsanpham", myArr).Tables[0];
        }
        public static DataTable Congsuatmayhoanthienchotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Congsuatmayhoanthienchotungsanpham", "Congsuatmayhoanthienchotungsanpham", myArr).Tables[0];
        }
        public static DataTable Congsuatmaychiachotungsanpham(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Congsuatmaychiachotungsanpham", "Congsuatmaychiachotungsanpham", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachghep(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachghep", "Nhucaulapkehoachghep", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachthoi(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachthoi", "Nhucaulapkehoachthoi", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachin(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachin", "Nhucaulapkehoachin", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachtua(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachtua", "Nhucaulapkehoachtua", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachhoanthien(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachhoanthien", "Nhucaulapkehoachhoanthien", myArr).Tables[0];
        }
        public static DataTable Nhucaulapkehoachchia(DateTime Tungay, DateTime Denngay, bool Daphatlenh)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Nhucaulapkehoachchia", "Nhucaulapkehoachchia", myArr).Tables[0];
        }
        public static DataTable Ngaysudungmay(DateTime Tungay, DateTime Denngay, string Madongmay, string Mamays)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            parameters.Add(new SqlParameter("@Mamays", SqlDbType.NVarChar, 0), Mamays);
        ...
        public static DataTable Danhsachnguyenlieu(string Manguyenlieu, string Manhom, DateTime Ngay)
        {
            ...
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Manguyenlieu", SqlDbType.NVarChar, 0), Manguyenlieu);
            parameters.Add(new SqlParameter("@Manhom", SqlDbType.NVarChar, 0), Manhom);
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
        ...
        public static DataTable Danhsachketquathoi(DateTime Tungay, DateTime Denngay, int Ca, string Mamay, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquathoichitiet(DateTime Ngay, int Ca, string Mamay, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
        ...
        public static DataTable Danhsachketquachia(DateTime Tungay, DateTime Denngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquachiachitiet(DateTime Ngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
        ...
        public static DataTable Danhsachketquaghep(DateTime Tungay, DateTime Denngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Danhsachketquaghep", "Danhsachketquaghep", myArr).Tables[0];
        }
        public static DataTable Danhsachketquaghepchitiet(DateTime Ngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Danhsachketquaghepchitiet", "Danhsachketquaghepchitiet", myArr).Tables[0];
        }

        public static DataTable Danhsachketquahoanthien(DateTime Tungay, DateTime Denngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquahoanthienchitiet(DateTime Ngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
        ...
        public static DataTable Danhsachketquain(DateTime Tungay, DateTime Denngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Loclenhsanxuat(DateTime Tungay, DateTime Denngay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Loclenhsanxuat", "Loclenhsanxuat", myArr).Tables[0];
        }

        public static DataTable Danhsachketquainchitiet(DateTime Ngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
        ...
        public static DataTable Danhsachketquatua(DateTime Tungay, DateTime Denngay, int Ca, string Mamay)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquatuachitiet(DateTime Ngay, int Ca, string Mamay, string Masp)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngay", SqlDbType.Date, 0), Ngay);
        ...
        public static DataTable Danhsachmangtuongtu(DateTime Ngayphatlenh, Decimal Doday, Decimal Rong, string Tenloaimang)
        {
            ...
            DictionaryEntry[] myArr = new DictionaryEntry[parameters.Count];
            parameters.CopyTo(myArr, 0);
            return _SimpleStoredProcedure.ExecuteSPReader(timeout, "Danhsachmangtuongtu", "Danhsachmangtuongtu", myArr).Tables[0];
        }
        #endregion
