  ...
  public  class Procedures
    {
        ...
        public static DataTable Danhsachnhapkhonguyenlieu(DateTime Tungay, DateTime Denngay, string Manguyenlieu)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachnhapkhonguyenlieuchitiet(DateTime MAHIEU_PK, string Manguyenlieu, string Makho, string Malydo)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Ngaynhap", SqlDbType.DateTime, 0), MAHIEU_PK);
        ...
        public static DataTable Danhsachphieugiaohang(DateTime Tungay, DateTime Denngay, string Sobaogia, string Sophieugiao, string Madonhang, string Makhachhang, string Mahang)
        ...
        public static DataTable Danhsachphieugiaohangchitiet(DateTime Tungay, DateTime Denngay, string Sobaogia, string Sophieugiao, string Madonhang, string Makhachhang, string Mahang)
        ...
        public static DataTable Danhsachketquathoi(DateTime Tungay, DateTime Denngay, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquathoichitiet(string MAHIEU_PK, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
        ...
        public static DataTable Danhsachketquain(DateTime Tungay, DateTime Denngay, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
            parameters.Add(new SqlParameter("@Tungay", SqlDbType.Date, 0), Tungay);
        ...
        public static DataTable Danhsachketquainchitiet(string MAHIEU_PK, string Mamang)
        {
            SimpleStoredProcedure _SimpleStoredProcedure = new SimpleStoredProcedure(ConnectionStringKeyName);
            ListDictionary parameters = new ListDictionary();
