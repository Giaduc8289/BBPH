...
{
    public partial class FRM_DMPARENT : GD.BBPH.CONTROL.FORM
    {
        ...
        public static void OpenFormByName(string strFormName, string strParam, Form fmain)
        {
            ...
            //{
            //    _fmain = fmain;
            //    //foreach (GD.BBPH.CONTROL.FORM frm in fmain.MdiChildren)
            //    //{
            ...
            //    if (!string.IsNullOrEmpty(strParam))
                ...
                //    {
                //        GD.BBPH.DANHMUC.FRM_DMNHANVIEN frm_nhanvien = new FRM_DMNHANVIEN(strParam);
                ...
                //    {
                //        GD.BBPH.DANHMUC.FRM_DMKHACHHANG frm_khachhang = new FRM_DMKHACHHANG(strParam);
                ...
                //    {
                //        GD.BBPH.DANHMUC.FRM_DMNHACUNGCAP frm_nhacungcap = new FRM_DMNHACUNGCAP(strParam);
                ...
                //    {
                //        GD.BBPH.DANHMUC.FRM_HRNHANVIEN frm_hrnhanvien = new FRM_HRNHANVIEN(strParam);
                ...
                //    {
                //        GD.BBPH.DANHMUC.FRM_DMLICHLV frm_khachhang = new FRM_DMLICHLV(strParam);
                //        frm_khachhang.StartPosition = FormStartPosition.CenterScreen;
                //        frm_khachhang.ShowDialog();
                //    }
                //    else
                //    {
                //        Form frmCheck = (Form)System.Type.GetType("GD.BBPH.DANHMUC." + strFormName).GetConstructor(System.Type.EmptyTypes).Invoke(null);
