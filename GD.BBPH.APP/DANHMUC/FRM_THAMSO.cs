...
{
    public partial class FRM_THAMSO : GD.SXBB.APP.DANHMUC.FRM_DMPARENT
    {
        public FRM_THAMSO()
        {
            InitializeComponent();
        ...
        private void CreateTab(ref DataTable dtView, ref TabPage m_tab, DataTable dt, int _index)
        {
            ...
            //GD.SXBB.CONTROL.JGridEX GRID_THAMSO = new GD.SXBB.CONTROL.JGridEX();
            //GD.SXBB.LIB.GRID_COMM.LOAD_GRID_SYS_TabPage(LIB.PATH.KTXPT_PATH + @"\XMLCONFIG\FRM_THAMSO.xml", GRID_THAMSO, m_tab, true);
        ...
        void m_tab_Paint(object sender, PaintEventArgs e)
        {
            ...
            //GD.SXBB.CONTROL.JGridEX GRID_THAMSO = (GD.SXBB.CONTROL.JGridEX)((TabPage)sender).Controls[0];
